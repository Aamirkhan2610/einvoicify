      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Welcome back, {session.admin.name}. Overview of website CRM activity.
          </p>
        </div>
            ...
            <ul className="divide-y divide-slate-100">
              {recentEnquiries.length === 0 ? (
                <li className="px-5 py-8 text-center text-sm text-slate-500">
                  No enquiries yet. They appear when visitors submit the contact
                  form or start a chat.
                </li>
              ) : (
          ...
          <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <ul className="divide-y divide-slate-100">
              {recentChats.length === 0 ? (
                <li className="px-5 py-8 text-center text-sm text-slate-500">
                  No chats yet. Website visitors use the chat widget for product
